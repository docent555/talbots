...
!
!function a0_fn_stat() result(a0_res)
!    use fun, only: nx, hx, iimp_x0, a0_peak, pi, imp_xsp, imp_x0, iimp_xend, in_type, lx, central_mirror, xcp, alfa!, coeff
!    use fourier
!
!    implicit none
!
...
!
!function dn_fn() result(dn_res)
!    use fun, only: nk, c_double_complex, c_double, lambda, lx, im1, pi
!
!    implicit none
!
!    complex(c_double_complex), dimension(nk) :: dn_res
...
!!    use fun only : a1, a0, ak1, ak0, atmp, jk1, jk0, dadx, k, ex, &
!!        th0, th1, dthdz, fk1, fk2, rhs0, z, x, k2, &
